    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="{{ route('home') }}"><img class="logo-img" src="{{ asset('assets/img/rei-logo.png') }}" alt=""></a>
                <!-- Navbar Toggler -->
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                @if(user())
                    <!-- Cart Area -->
                    <div class="cart-area">
                        <a href="{{ route('cart.index') }}" id="essenceCartBtn"><img src="{{ asset('assets/front/img/core-img/bag.svg') }}" alt=""> <span id="count-cart"></span></a>
                    </div>
                    <!-- User Login Info -->
