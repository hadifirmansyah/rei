                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                {!! Form::open(['route' => 'admin.places.cities.store', 'files' => true]) !!}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('province_id', 'Province', ['class' => 'control-label']) }}
                                                {{ Form::select('province_id', $provinces, null, ['placeholder' => 'Pick a Province', 'id' => 'province_id', 'class' => 'form-control']) }}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('name', 'City Name', ['class' => 'control-label']) }}
                                                {{ Form::text('name', null, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'City Name']) }}
                                            </div>
                                        </div>
                                    </div>
